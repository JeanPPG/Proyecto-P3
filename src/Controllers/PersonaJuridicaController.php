...
final class PersonaJuridicaController
{
    private PersonaJuridicaRepository $repo;
    ...
    private function toArray(PersonaJuridica $p): array
    {
        return [
            'id'                  => $p->getId(),
            'email'               => $p->getEmail(),
            ...
            'ruc'                 => $p->getRuc(),
            'representanteLegal'  => $p->getRepresentanteLegal(),
        ];
    }
}
